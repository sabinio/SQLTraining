...
"%ProgramFiles(x86)%\Microsoft Visual Studio 12.0\Common7\IDE\Extensions\Microsoft\SQLDB\DAC\120\SqlPackage.exe" /Action:Publish /SourceFile:"%BUILD_REPOSITORY_LOCALPATH%\SimpleUnitTest_DB\SimpleUnitTest_DB\bin\%1\SimpleUnitTest_DB.dacpac" /Profile:"%BUILD_REPOSITORY_LOCALPATH%\SimpleUnitTest_DB\SimpleUnitTest_DB\bin\%1\localdb_SimpleUnitTest_DB.publish.publish.xml"
